...
function Label(props) {
  ...
  return _react2.default.createElement(
    "label",
    { className: "rjsf-control-label", htmlFor: id },
...
function ErrorList(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "ul",
      { className: "rjsf-error-detail rjsf-bs-callout rjsf-bs-callout-info" },
      errors.map(function (error, index) {
        return _react2.default.createElement(
          "li",
          { className: "rjsf-text-danger", key: index },
          error
        );
      })
    )
...
function SchemaFieldRender(props) {
  ...
  var classNames = ["rjsf-form-group", "rjsf-field", "rjsf-field-" + type, errors && errors.length > 0 ? "rjsf-field-error rjsf-has-error rjsf-has-danger" : "", uiSchema.classNames].join(" ").trim();
