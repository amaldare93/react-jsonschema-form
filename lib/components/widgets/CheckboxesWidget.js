...
function CheckboxesWidget(props) {
  ...
  return _react2.default.createElement(
    "div",
    { className: "rjsf-checkboxes", id: id },
    enumOptions.map(function (option, index) {
      var checked = value.indexOf(option.value) !== -1;
      var disabledCls = disabled || readonly ? "rjsf-disabled" : "";
      ...
      return inline ? _react2.default.createElement(
        "label",
        { key: index, className: "rjsf-checkbox-inline " + disabledCls },
        checkbox
      ) : _react2.default.createElement(
        "div",
        { key: index, className: "rjsf-checkbox " + disabledCls },
        _react2.default.createElement(
          "label",
          null,
          checkbox
